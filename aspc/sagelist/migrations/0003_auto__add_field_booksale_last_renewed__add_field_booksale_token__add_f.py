...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BookSale.last_renewed'
        db.add_column('sagelist_booksale', 'last_renewed',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 18, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'BookSale.token'
        db.add_column('sagelist_booksale', 'token',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BookSale.expired'
        db.add_column('sagelist_booksale', 'expired',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BookSale.last_renewed'
        db.delete_column('sagelist_booksale', 'last_renewed')

        # Deleting field 'BookSale.token'
        db.delete_column('sagelist_booksale', 'token')

        # Deleting field 'BookSale.expired'
        db.delete_column('sagelist_booksale', 'expired')
    ...
    models = {
        ...
        'sagelist.booksale': {
            ...
            'last_renewed': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'token': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'})
        }
    }
